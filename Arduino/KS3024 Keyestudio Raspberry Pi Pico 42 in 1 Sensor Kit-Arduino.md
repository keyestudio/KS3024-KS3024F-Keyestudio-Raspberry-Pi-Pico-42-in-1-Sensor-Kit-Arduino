...
<td><img src="https://raw.githubusercontent.com/keyestudio/KS3024-KS3024F-Keyestudio-Raspberry-Pi-Pico-42-in-1-Sensor-Kit-Arduino/master/media/b83cfda6f21c26037d7f5bd5c403a2c7.png" style="width:1.55139in;height:1.17986in" /></td>
...
<td><img src="https://raw.githubusercontent.com/keyestudio/KS3024-KS3024F-Keyestudio-Raspberry-Pi-Pico-42-in-1-Sensor-Kit-Arduino/master/media/10e7df934f3065f87ecb0163a49b6a31.png" style="width:1.65556in;height:1.29514in" /></td>
...
<td><img src="https://raw.githubusercontent.com/keyestudio/KS3024-KS3024F-Keyestudio-Raspberry-Pi-Pico-42-in-1-Sensor-Kit-Arduino/master/media/6f7cbd758d774713bd4181000d7efe1b.png" style="width:1.74514in;height:1.31389in" /></td>
...
<td><img src="https://raw.githubusercontent.com/keyestudio/KS3024-KS3024F-Keyestudio-Raspberry-Pi-Pico-42-in-1-Sensor-Kit-Arduino/master/media/6dcf2be9ac58a9c685ca2f64ffa32dfc.png" style="width:1.31181in;height:0.98819in" /></td>
...
<td><img src="https://raw.githubusercontent.com/keyestudio/KS3024-KS3024F-Keyestudio-Raspberry-Pi-Pico-42-in-1-Sensor-Kit-Arduino/master/media/907f79d7a0c3500820323343b0ef4681.png" style="width:1.41806in;height:1.05556in" /></td>
...
<td><img src="https://raw.githubusercontent.com/keyestudio/KS3024-KS3024F-Keyestudio-Raspberry-Pi-Pico-42-in-1-Sensor-Kit-Arduino/master/media/0ef1583b201c7944ba95ac97ee8a4ba8.png" style="width:1.55417in;height:1.16319in" /></td>
...
<td><img src="https://raw.githubusercontent.com/keyestudio/KS3024-KS3024F-Keyestudio-Raspberry-Pi-Pico-42-in-1-Sensor-Kit-Arduino/master/media/af24d0e4bc9435881820504724ad3fcd.png" style="width:2.07778in;height:1.03542in" /></td>
...
<td><img src="https://raw.githubusercontent.com/keyestudio/KS3024-KS3024F-Keyestudio-Raspberry-Pi-Pico-42-in-1-Sensor-Kit-Arduino/master/media/af90db3a116c8db533c7fea7e65fa99d.png" style="width:1.58958in;height:0.95278in" /></td>
...
<td><img src="https://raw.githubusercontent.com/keyestudio/KS3024-KS3024F-Keyestudio-Raspberry-Pi-Pico-42-in-1-Sensor-Kit-Arduino/master/media/cac2d3a8fd0e147e67dc6554caeef395.png" style="width:1.77708in;height:1.51528in" /></td>
...
<td><img src="https://raw.githubusercontent.com/keyestudio/KS3024-KS3024F-Keyestudio-Raspberry-Pi-Pico-42-in-1-Sensor-Kit-Arduino/master/media/530cb53e5b1e1b140de487cfc46be453.png" style="width:1.69653in;height:0.94653in" /></td>
...
<td><img src="https://raw.githubusercontent.com/keyestudio/KS3024-KS3024F-Keyestudio-Raspberry-Pi-Pico-42-in-1-Sensor-Kit-Arduino/master/media/10ccf14d80feba64bba0c1eacd02b09d.png" style="width:2.07222in;height:1.00139in" /></td>
...
<td><img src="https://raw.githubusercontent.com/keyestudio/KS3024-KS3024F-Keyestudio-Raspberry-Pi-Pico-42-in-1-Sensor-Kit-Arduino/master/media/33be6266ae36f54c9e7ffd044eae9320.png" style="width:2.07986in;height:0.64583in" /></td>
...
**Wiring Diagram**![](/media/00ef9bf64d6866acfed596128fbb0401.png)
...
**//The two pins of the smoke sensor are connected to 22 and 26
respectively.**
...
**//The following two variables store the digital signal and the analog
signal respectively int analogVal = 0;**
...
Upload the test code successfully, power up with a USB cable, the red
led LED on the module lights up and open the serial monitor and set baud
rate to 9600. The serial monitor displays the corresponding data and
characters. In the experiment, we can see that when the simulated value
of the test is less than or equal to 2788, the gas content does not
exceed the critical point, and the yellow-green LED is off; when the
simulated value of the test is greater than or equal to 2800, the gas
content exceeds the critical point, and the yellow-green LED lights up;
then that means that the analog value of the alcohol vapor content
critical point is between 2788-2800, we can adjust the critical point by
...
**void loop()  else if (val \<= 1200)  else if (val \<= 2000)  else if (val \<= 2800)  else if (val \<= 3500)  else **
...
When the analog value is in the range of 500 and 1200, the button SW5 is
pressed; when the analog value is in the 1200 and 2000, the button SW4
is pressed; when the analog value is between 2000 and 2800, the button
SW3 is pressed; when the analog value is between 2800 and 3500, the
button SW2 is pressed. Press; When the analog value is above 3500, we
judge that the button SW1 is pressed.

**Test Result**

After uploading the test code successfully, power on, open the serial
monitor and set baud rate to 9600; when the button is pressed, the
serial monitor prints out the corresponding information, as shown in the
figure below.
...
**int Encoder\_Switch = 20;**

**int Previous\_Output;**
...
**Previous\_Output = digitalRead(Encoder\_DT);**

**if (digitalRead(Encoder\_Switch) == 0)**
...
**unsigned char dht\[4\] = ;//only receive the data before
32 bit**
...
![](/media/949abbbea3c8d8b36463768a39a07b51.png)**Overview**
...
**\#include "adxl345\_io.h"**

**//the port is sda--\>9,scl--\>910**

**adxl345 adxl345(9, 10);**

**float out\_X, out\_Y, out\_Z;**
...
Upload the test code, power on with a USB cable, open the serial monitor
and set baud rate to 9600. The serial monitor displays the value
corresponding to the sensor, the unit is g, as shown in the figure
below. ![](/media/7836b1f3246cb2b82559441d1b4479c3.jpeg)
...
**const uint8\_t LedArray1\[8\] PROGMEM = ;//heart beat pattern**
...
After uploading the test code, wire up and power up, the first line of
the 128X32LCD module display shows "KEYES", the second line shows
"ABCDEFGHIJKLMNOPQR", and the third line shows "123456789+-\*/\<\> =$@",
the fourth line displays "%^&(){}:;'|?,.\~\\\\\[\]", as shown in the
following figure:
...
**// 0x28 is the i2c address on SDA. If it doesn't match, check your
address with i2cscanner**
...
Wire up, run the test code, power up and open the monitor and set baud
rate to 9600.When we make the IC card close to the RFID module, the
...
**int tune\[\] = //List the frequencies according to the numbered
musical notation**

**;**

**float durt\[\] = //List the beats according to the numbered musical
notation**
...
In the code, we set the threshold value to 2000. When the flame sensor
detects that the analog value is lower than this threshold, the fan will
automatically turn on; otherwise, it will be turned off. For the driving
method of the fan, please refer to the previous experiment sixteen 130
motor.

**Test Result**

Wire up and upload the test code, power up, open the monitor and set
baud rate to 9600. When this value is less than 2000, the fan will works
to blow out the fire. Basically, the flame value can be set by yourself.
...
1.  In the experiment we set val to the remainder of dividing
    Encoder\_Count by 3. Encoder\_Count is the value of the encoder.
    After getting the remainder, set the pins to 9 (red light), 10
    (green light) and 11 (blue light) according to the wiring.
    ...
    **Test Result**
    ...
    Wire up, run the code, open the serial monitor and set baud rate to
    9600. Rotate the knob of the rotary encoder to display the
    reminders, which can control colors of LED.
...
In the experiment, the mapping function maps val1 from the range of
0-4095 to 0-255, and assigns it to val2.
...
The code setting is the same as the previous experiment, define an
integer variable val to store the analog value of the alcohol sensor,
and then we display the analog value in the four-digit digital tube, and
then set a threshold, when the threshold is reached, the predestined
buzzer sounded.
...
.setPixelColor(num - 1, R, G, B)：set the light beads at num-1 to display
...
**void loop()  else if (distance \> 10 && distance \<= 20)  else **
...
**rfid\_str = "";//character strings clear up**
...
**unsigned char dht\[4\] = ;//receive 32 bit data**
...
**void loop()  else if (yushu == 1)  else if (yushu == 2)  else if (yushu == 3) else if (yushu == 4)  else if (yushu == 5)  else if (yushu == 6)  else if (yushu == 7) **
...
At the beginning, the number of the button is 0 and remainder is 0. Open
the monitor and set baud rate to 9600. Press the button, the RGB stops
flashing, press once, the remainder is 1. If we point at IR receiver
with the infrared remote control and press the button,the serial monitor
